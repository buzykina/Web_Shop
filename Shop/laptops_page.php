...
<div id="combined">
	<div class="fillters">
		...
		<h4>Brand</h4>
		<div>
			<input type="radio" class="radio1" onclick="apple()" name="brand" value="Apple"><label>Apple</label><br>
			<input type="radio" class="radio1" onclick="asus()" name="brand" value="Asus"><label>Asus</label><br>
			<input type="radio" class="radio1" onclick="acer()" name="brand" value="Acer"><label>Acer</label><br>
		</div>
		...
		<div>
			...
			<input type="radio" onclick="black()" name="colour" value="Black" checked><label>Black</label><br>
	...
	<div id="products">
			<div id = "product">
				...
				<li id = "price">
					<h3>$949</h3><br><button class="AddToBasket" onclick="AddRow()">Add to cart</button>
				</li>
				</ul>
			</div>
			<div id = "product">
