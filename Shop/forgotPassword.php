	...
	<div id ="forgot_container">
		<h2>Recover Password</h2><br>
			<form class="login_form">
				...
				<input type="text" name="emailPassword" size = "25">    <input id="bt_regi" type="submit" name="recoverLogIn" value="Enter"><br><br>
				<label>Haven't recieved your password yet? Click the button bellow</label><br><br>
				<input id="bt_regi" type="submit" name="resendEmailPassword" value="Send Password Again"><br><br>
