...
<div class="fillters">
	...
	<h4>Brand</h4>
	<div>
		<input type="radio" name="brand" value="JBL" checked><label>JBL</label><br>
		<input type="radio" name="brand" value="SONY"><label>SONY</label><br>
		<input type="radio" name="brand" value="Bose"><label>Bose</label><br>
	</div>
	...
	<div>
		<input type="radio" name="type" value="Waterproof" checked><label>Waterproof</label><br>
		<input type="radio" name="type" value="Not waterproof"><label>Not waterproof</label><br>
	</div>

	<h4>Colour</h4>

	<div>
		<input type="radio" name="colour" value="Blue"><label>Blue</label><br>
		<input type="radio" name="colour" value="Black" checked><label>Black</label><br>
		<input type="radio" name="colour" value="Gray"><label>Gray</label><br>
	</div>
	<br>
</div>
<div id="products">
