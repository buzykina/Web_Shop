...
<div class="fillters">
	...
	<h4>Brand</h4>
	<div>
		<input type="radio" name="brand" value="Corsair" checked><label>Corsair</label><br>
		<input type="radio" name="brand" value="Speedlink"><label>Speedlink</label><br>
		<input type="radio" name="brand" value="Logitech G"><label>Logitech G</label><br>
	</div>
	...
	<div>
		<input type="radio" name="OS" value="Wired" checked><label>Wired</label><br>
		<input type="radio" name="OS" value="Bluetooth"><label>Bluetooth</label><br>
	...
	<div>
		<input type="radio" name="colour" value="Grey"><label>Grey</label><br>
