...
<table id = "table2">
  <tr>
    <th>Sub Total:</th>
      <td><div class= "<?php echo $product['laptopID'];?>">$<?php echo number_format($total,2);?></td>
  </tr>
  <tr>
   ...
   <tr>
    <th>Total Amount:</th>
    <td><div class= "<?php echo $product['laptopID'];?>">$<?php echo number_format((1+0.21)*($total+50),2);?></td>
   </tr>
</table>
</div>
